...
import type { ProxyContext, ProxyHandler, ProxyHandlerConfig, ServiceConfig } from "./types";
 ...
 */
function parseProxyPath(pathname: string, mountPath: string): { service: string; path: string } {
