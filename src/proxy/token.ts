...
import type { CreateProxyTokenOptions, ProxyTokenPayload, VerifyProxyTokenOptions } from "./types";
...
function parseExpiresIn(expiresIn: string): number {
  ...
  if (!match) {
    throw new Error(`Invalid expiresIn format: ${expiresIn}. Use '30m', '2h', '1d', or seconds.`);
  }
