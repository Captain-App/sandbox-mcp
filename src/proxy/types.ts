...
export interface ServiceConfig<TEnv = unknown> {
   ...
   */
  transform: (request: Request, ctx: ProxyContext<TEnv>) => Promise<Request | Response>;
}
 ...
 */
export type ProxyHandler<TEnv = unknown> = (request: Request, env: TEnv) => Promise<Response>;
